# Paste into Vercel > Settings > Environment Variables. Never into git.

TELEGRAM_BOT_TOKEN=
TELEGRAM_CHAT_ID=7087735312
TELEGRAM_WEBHOOK_SECRET=

# Service account, NOT OAuth. From the downloaded JSON key.
GOOGLE_SA_EMAIL=ronan-os-bot@yourproject.iam.gserviceaccount.com
# Copy exactly as it appears in the JSON, keeping the literal \n sequences.
GOOGLE_SA_PRIVATE_KEY=
# MUST be your email address. NOT 'primary' - that is the service account's own empty calendar.
...

{
  ...
  "private": true,
  "type": "module",
  "description": "Personal operating system. Telegram front end, Google Calendar spine, Supabase task layer.",
  "engines": { "node": ">=20" },
  "scripts": {
    "setup:webhook": "node scripts/set-webhook.js",
    
    "test:tick": "node scripts/test-tick.js"
  }
}
...

{
  ...
  "functions": {
    "api/telegram.js": { "maxDuration": 60 },
    "api/cron/tick.js": { "maxDuration": 60 }
  }
}
